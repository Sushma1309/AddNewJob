                  ...
                  <form>
                    ...
                    <div className="form-group mb-0">
                      <div className="text-center">
                        <button className="btn btn-primary draft"><span>Send</span> <i className="fa fa-send m-l-5" /></button>
                        <button className="btn btn-success draft m-l-5" type="button"><span>Draft</span> <i className="fa fa-floppy-o m-l-5" /></button>
