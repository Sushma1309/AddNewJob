                  ...
                  <div className="navbar">
                    ...
                    <ul className="nav custom-menu">
                      <li className="nav-item">
                        <Link className="nav-link task-chat profile-rightbar float-end" id="task_chat" to="#task_window"><i className="fa fa-user" /></Link>
                      </li>
                      <li className="nav-item">
                      ...
                      <li className="nav-item dropdown dropdown-action">
                        <Link aria-expanded="false" data-bs-toggle="dropdown" className="nav-link dropdown-toggle" to=""><i className="fa fa-cog" /></Link>
                        <div className="dropdown-menu dropdown-menu-right">
                          <Link to="" className="dropdown-item">Delete Conversations</Link>
                            ...
                            <div className="chat-body">
                              <div className="chat-bubble">
                                ...
                                <div className="chat-action-btns">
                                  <ul>
                                    <li><Link to="#" className="share-msg" title="Share"><i className="fa fa-share-alt" /></Link></li>
                                    <li><Link to="#" className="edit-msg"><i className="fa fa-pencil" /></Link></li>
                                    <li><Link to="#" className="del-msg"><i className="fa fa-trash-o" /></Link></li>
                                  </ul>
                                </div>
                              </div>
                            </div>
                              ...
                              <div className="chat-bubble">
                                <div className="chat-content">
                                  ...
                                  <ul className="attach-list">
                                    <li><i className="fa fa-file" /> <Link to="#">example.avi</Link></li>
                                    <li><i className="fa fa-file" /> <Link to="#">activity.psd</Link></li>
                                    <li><i className="fa fa-file" /> <Link to="#">example.psd</Link></li>
                                  </ul>
                                </div>
                                <div className="chat-action-btns">
                                  <ul>
                          ...
                          <div className="chat chat-left">
                            ...
                            <div className="chat-body">
                              <div className="chat-bubble">
                                <div className="chat-content">
                                  <ul className="attach-list">
                                    <li className="pdf-file"><i className="fa fa-file-pdf-o" /> <Link to="#">Document_2016.pdf</Link></li>
                                  </ul>
                                  <span className="chat-time">9:00 am</span>
                                </div>
                                <div className="chat-action-btns">
                ...
                <div className="chat-footer">
                  <div className="message-bar">
                    <div className="message-inner">
                      <Link className="link attach-icon" to="#" data-bs-toggle="modal" data-bs-target="#drag_files"><img src={Attachment} alt="" /></Link>
              ...
              <div className="chat-window video-window">
                <div className="fixed-header">
                  <ul className="nav nav-tabs nav-tabs-bottom">
                    <li className="nav-item"><Link className="nav-link" to="#calls_tab" data-bs-toggle="tab">Calls</Link></li>
                    <li className="nav-item"><Link className="nav-link active" to="#profile_tab" data-bs-toggle="tab">Profile</Link></li>
                  </ul>
                </div>
                              ...
                              <div className="chat-bubble">
                                <div className="chat-content">
                                  ...
                                  <div className="call-details">
                                    ...
                                    <div className="call-info">
                                      <div className="call-user-details">
                                        <Link to="#" className="call-description call-description--linked" data-qa="call_attachment_link">Calling John Smith ...</Link>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                        ...
                        <div className="table-body">
                          <div className="table-content">
                            <div className="chat-profile-img">
                              ...
                              <Link to="" className="btn btn-primary edit-btn"><i className="fa fa-pencil" /></Link>
                            </div>
                            ...
                            <div className="transfer-files">
                              <ul className="nav nav-tabs nav-tabs-solid nav-justified mb-0">
                                <li className="nav-item"><Link className="nav-link active" to="#all_files" data-bs-toggle="tab">All Files</Link></li>
                                <li className="nav-item"><Link className="nav-link" to="#my_files" data-bs-toggle="tab">My Files</Link></li>
                              </ul>
                                    ...
                                    <li>
                                      <div className="files-cont">
                                        ...
                                        <div className="files-info">
                                          ...
                                          <span className="file-author"><Link to="#">Loren Gatlin</Link></span> <span className="file-date">May 31st at 6:53 PM</span>
                                        </div>
                                        <ul className="files-action">
                                          <li className="dropdown dropdown-action">
                                            <Link to="" className="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i className="material-icons">more_horiz</i></Link>
                                            <div className="dropdown-menu">
                                              <Link className="dropdown-item" to="">Download</Link>
                                              <Link className="dropdown-item" to="#" data-bs-toggle="modal" data-bs-target="#share_files">Share</Link>
                                            </div>
                                          </li>
                                        </ul>
                                      </div>
                                  ...
                                  <ul className="files-list">
                                    <li>
                                      <div className="files-cont">
                                        ...
                                        <div className="files-info">
                                          <span className="file-name text-ellipsis">AHA Selfcare Mobile Application Test-Cases.xls</span>
                                          <span className="file-author"><Link to="#">John Doe</Link></span> <span className="file-date">May 31st at 6:53 PM</span>
                                        </div>
                                        <ul className="files-action">
                                          <li className="dropdown dropdown-action">
                                            <Link to="" className="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i className="material-icons">more_horiz</i></Link>
              ...
              <div className="modal-body">
                <div className="files-share-list">
                  <div className="files-cont">
                    ...
                    <div className="files-info">
                      <span className="file-name text-ellipsis">AHA Selfcare Mobile Application Test-Cases.xls</span>
                      <span className="file-author"><Link to="#">Bernardo Galaviz</Link></span> <span className="file-date">May 31st at 6:53 PM</span>
                    </div>
                  </div>
                </div>
                <div className="form-group">
