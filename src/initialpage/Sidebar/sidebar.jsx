            ...
            <nav className="greedys sidebar-horizantal" id='horizantal-sidebar'>
              ...
              <ul className="hidden-links hidden" id="more-menu-hidden">
                ...
                <li className="submenu">
                  ...
                  {isSideMenu == "jobs" ?
                    <ul>
                      <li><Link className={pathname.includes('user-dashboard') || pathname.includes('user-all-jobs') || pathname.includes('saved-jobs') || pathname.includes('addjobs')
                      ...
                      <li><Link className={pathname.includes('addjobs') ? "active" : ""} to="/app/administrator/addjobs"> Add Job </Link></li>
